...
const Habits = () => {
  ...
  function checkStatusHabit(goal) {
    ...
    // TODO: I can see that this is 24 hours, but this can be made much more
    // readable, by convention you may use a suffix e.g. `ms` to signify units
    // and define constants to use for larger units in the same dimension
    //
    // const secondMs = 1000
    // const minuteMs = 60 * secondMs
    // const hourMs = 60 * minuteMs
    // const dayMs = 24 * hourMs
    // const elapsedMs = Date.now() - goal.timestamp
    //
    // if (elapsedMs > (2 * dayMs) && goal.status === 'progress') {
    //    ...
    // }
